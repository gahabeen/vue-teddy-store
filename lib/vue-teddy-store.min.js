var VueTeddyStore = (function () {
	...
	var vueCompositionApi_umd = createCommonjsModule(function (module, exports) {
	...
	var vueCompositionApi_umd$1 = /*@__PURE__*/unwrapExports(vueCompositionApi_umd);
	...
	function set$1(obj, path, value, instance) {
	...
	var HistoryPlugin = {
	  handle: function handle(ref) {
	    ...
	    store._history = vueCompositionApi_umd$1.reactive([]);
	    vueCompositionApi_umd$1.watch(
	      store._state,
	      function (newState) {
	    ...
	    if (window) {
	      window.addEventListener('storage', function (e) {
	        if (e.key === prefix(name)) {
	          store._state = vueCompositionApi_umd$1.reactive(Object.assign({}, store._state, JSON.parse(e.newValue)));
	        }
	      });
	    }
	  },
	...
	var TeddyStore = function TeddyStore() {
	  this._stores = vueCompositionApi_umd$1.reactive({});
	  this._plugins = vueCompositionApi_umd$1.reactive({
	    cache: CachePlugin,
	...
	TeddyStore.prototype.add = function add (name, store) {
	  ...
	  this._stores = Object.assign({}, this._stores,
	    ( obj = {}, obj[name] = vueCompositionApi_umd$1.reactive(Object.assign({}, {_state: _state,
	      state: state},
	      (store.methods || {}),
	      others)), obj ));
	  ...
	  for (var watcher of watchers) {
	    if (typeof watcher === 'function') {
	      vueCompositionApi_umd$1.watch(this._stores[name].state, watcher, { deep: true });
	      ...
	      if (path) {
	        ...
	        vueCompositionApi_umd$1.watch(function () { return get(this$1._stores[name].state, path); }, handler, Object.assign({}, {deep: true}, options));
	        ...
	        vueCompositionApi_umd$1.watch(function () { return this$1._stores[name].state; }, handler, Object.assign({}, {deep: true}, options));
	      }
	    }
	  }
	...
	TeddyStore.createState = function createState (stateObj) {
	  ...
	  var _state = vueCompositionApi_umd$1.isRef(stateObj) ? stateObj : vueCompositionApi_umd$1.ref(stateObj);
	  /* Until it's made available by Vue 3, be careful with { state } as it can be deeply mutable*/
	  // const state = readonly(() => _state.value)
	  var state = vueCompositionApi_umd$1.computed(function () { return _state.value; });
	...
	TeddyStore.set = function set (name, path, context) {
	  ...
	  return function set(value) {
	    var _instance = getInstance(this, context);
	    try {
	      set$1(_instance.stores[name]._state, path, value, context);
	    } catch (error) {
	      /* istanbul ignore next */
