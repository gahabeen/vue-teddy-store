var VueTeddyStore = (function () {
  ...
  function isVueRegistered(Vue) {
      return hasOwn$1(Vue, PluginInstalledFlag);
  }
  ...
  ***************************************************************************** */
  ...
  var RawIdentifier = {};
  function isRaw(obj) {
      return (hasOwn$1(obj, RawIdentifierKey) && obj[RawIdentifierKey] === RawIdentifier);
  }
  function isReactive(obj) {
      return (isObject$1(obj) &&
          Object.isExtensible(obj) &&
          hasOwn$1(obj, ReactiveIdentifierKey) &&
  ...
  function setupAccessControl(target) {
      ...
      if (hasOwn$1(target, AccessControlIdentifierKey) &&
  ...
  function markReactive(target, shallow) {
      ...
      if (hasOwn$1(target, ReactiveIdentifierKey) &&
          target[ReactiveIdentifierKey] === ReactiveIdentifier) {
          return;
      }
      if (Object.isExtensible(target)) {
          def$1(target, ReactiveIdentifierKey, ReactiveIdentifier);
      }
      if (shallow) {
          return;
      }
  ...
  function markRaw(obj) {
      if (!isPlainObject$1(obj) || !Object.isExtensible(obj)) {
          return obj;
      }
      // set the vue observable flag at obj
      def$1(obj, '__ob__', observe$1({}).__ob__);
      // mark as Raw
      def$1(obj, RawIdentifierKey, RawIdentifier);
      return obj;
  }
  ...
  function createWatcher$1(vm, source, cb, options) {
  ...
  function watch(source, cb, options) {
      ...
      var vm = getWatcherVM();
      return createWatcher$1(vm, source, callback, opts);
  }
  ...
  function resolveScopedSlots$1(vm, slotsProxy) {
      ...
      var curSlots = resolveSlots$1(parentVNode.data.scopedSlots, vm.$slots);
      // remove staled slots
              ...
              Object.keys(binding).forEach(function (name) {
                  ...
                  if (!isRef(bindingValue)) {
                      if (isReactive(bindingValue)) {
                          ...
                          bindingValue = ref$1(markRaw(unwrapped));
                      }
                  }
  ...
  function resolvePath(instance) {
    return function (path) {
      var variablePath = get$1(instance, path.slice(1, -1).trim());
  ...
  function setProp$1(obj, key, value) {
    if (isComputed(obj) && key in obj.value) {
      obj.value[key] = value;
      return obj.value[key]
    } else {
  ...
  function get$1(obj, path, defaultValue, instance) {
  ...
  function set$2(obj, path, value, instance) {
    var steps = String(path)
      .replace(/\[/g, '.')
      .replace(/]/g, '')
      .replace(VARIABLE_PATH, resolvePath(instance))
    ...
    var _set = function (item, steps, val) {
      ...
      if (steps.length > 0) {
        if (Number.isInteger(+steps[0])) {
          return _set(setProp$1(item, step, []), steps, val)
          ...
          return _set(setProp$1(item, cleanStep(step), {}), steps, val)
        } else {
          return _set(getProp(item, cleanStep(step)), steps, val)
        }
      } else {
        setProp$1(item, cleanStep(step), val);
      }
    };
  ...
  var prototypeAccessors$1 = { stores: { configurable: true } };
  ...
  TeddyStore.prototype.add = function add (name, store) {
    ...
    this._stores[name] = ref$1(Object.assign({}, states,
      (store.methods || {}),
      others));
    ...
    for (var watcher of watchers) {
      if (typeof watcher === 'function') {
        watch(function () { return this$1._stores[name].value.state.value; }, watcher, { deep: true });
        ...
        var handler = watcher.handler;
          ...
          var options = rest;
        if (path) {
          watch(function () { return get$1(this$1._stores[name].value.state.value, path); }, handler, Object.assign({}, {deep: true}, options));
        } else if (paths.length > 0) {
          watch(
            paths.map(function (p) { return function () { return get$1(this$1._stores[name].value.state.value, p); }; }),
            handler,
            Object.assign({}, {deep: true}, options)
          );
        } else {
          watch(function () { return this$1._stores[name].value.state.value; }, handler, Object.assign({}, {deep: true}, options));
        }
      }
    }
  ...
  prototypeAccessors$1.stores.get = function () {
    return this._stores
  };

  TeddyStore.createState = function createState (newState) {
    var _state = isReactive(newState) ? toRefs(newState) : isRef(newState) ? newState : ref$1(newState);
  ...
  TeddyStore.get = function get (name, path, context) {
    context = context || this;
    return function get() {
      var _instance = getInstance(this, context);
      var value = get$1(_instance, ("stores." + name + ".value.state.value." + path), undefined, context);
  ...
  TeddyStore.set = function set (name, path, context) {
    context = context || this;
    return function set(value) {
      console.log('set');
      var _instance = getInstance(this, context);
      set$2(_instance, ("stores." + name + "._state." + path), value, context);
  ...
  Object.defineProperties( TeddyStore.prototype, prototypeAccessors$1 );
