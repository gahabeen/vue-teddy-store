...
TeddyStore.prototype.add = function add (name, store) {
  ...
  this._stores = Object.assign({}, this._stores,
    ( obj = {}, obj[name] = reactive(Object.assign({}, {_state: _state,
      state: state},
      (store.methods || {}),
      others)), obj ));
  ...
  for (var watcher of watchers) {
    if (typeof watcher === 'function') {
      ...
      if (path) {
        ...
        watch(function () { return get(this$1._stores[name].state, path); }, handler, Object.assign({}, {deep: true}, options));
        ...
        watch(function () { return this$1._stores[name].state; }, handler, Object.assign({}, {deep: true}, options));
      }
    }
  }
